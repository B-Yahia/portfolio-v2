  ...
  return (
    <div className="footer_container">
      ...
      <div className="footer_msg">
        Let's create something amazing together! Feel free to drop me a line at
        <span> Yahiabahhous@gmail.com</span> or send me a message via the
        contact page. If it's urgent, I recommend doing both, and I'll get back
        to you as soon as possible! Looking forward to collaborating with you!
      </div>
